...
class OUYA_GAMEPAD
{
	...
	public static inline var RIGHT_ANALOGUE_X:Int = 14;
	public static inline var RIGHT_ANALOGUE_Y:Int = 15;
	 ...
	 * therefore, use pressed() or released().
	 */
	public static inline var HOME_BUTTON:Int = 14; // 82
...
class XBOX_GAMEPAD
{
	...
	public static inline var LEFT_TRIGGER:Int = 2;
	public static inline var RIGHT_TRIGGER:Int = 5;
#elseif android // default windows mapping
	public static inline var A_BUTTON:Int = 0;
	public static inline var B_BUTTON:Int = 1;
	public static inline var X_BUTTON:Int = 3;
	public static inline var Y_BUTTON:Int = 4;
...
class PS3_GAMEPAD
{
	...
	public static inline var RIGHT_ANALOGUE_Y:Int = 14;
#elseif android
	public static inline var TRIANGLE_BUTTON:Int = 4;//3
	public static inline var CIRCLE_BUTTON:Int =1;//2
	public static inline var X_BUTTON:Int = 0;//1
	public static inline var SQUARE_BUTTON:Int = 3;//0
	public static inline var L1_BUTTON:Int = 6;//4
	public static inline var R1_BUTTON:Int = 7;//5
	public static inline var L2_BUTTON:Int = 8;//6
	public static inline var R2_BUTTON:Int = 9;//7
	public static inline var SELECT_BUTTON:Int = 13;//8
	public static inline var START_BUTTON:Int = 12;//19
